<%-- 
    ...
    Created on : Jun 28, 2021, 5:26:00 PM
    Author     : Hùng
--%>
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="right">
                    <div class="solve">
                        <form action="SolveRequestController" >
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><textarea name="solution" ${getRequest.status == 1 ? "readonly":""}>${getRequest.solution}</textarea></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>
                                        <button class="${getRequest.status == 1 ? "hide":""}" type="submit">Save</button>
                                    </td>
                                </tr>
                            </table>
                        </form>
